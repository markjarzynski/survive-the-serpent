...
{
	public partial class SnakeHead : PositionedObject, IDestroyable
	{
        ...
        public SnakeHead(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
...
// Generated AddToManagers
		...
		public static void LoadStaticContent(string contentManagerName)
		{
			...
			if(IsStaticContentLoaded == false)
			{
				...
				if(!FlatRedBallServices.IsLoaded<Scene>(@"content/entities/snakehead/scenefile.scnx", ContentManagerName))
				{
					registerUnload = true;
				}
				SceneFile = FlatRedBallServices.Load<Scene>(@"content/entities/snakehead/scenefile.scnx", ContentManagerName);
	...
	// Extra classes
	public static class SnakeHeadExtensionMethods
	{
	}
