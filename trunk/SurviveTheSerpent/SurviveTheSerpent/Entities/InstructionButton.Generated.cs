...
namespace SurviveTheSerpent.Entities
{
	public partial class InstructionButton : PositionedObject, IDestroyable, IClickable
	{
        ...
        public InstructionButton(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
...
// Generated AddToManagers
		...
		public static void LoadStaticContent(string contentManagerName)
		{
			...
			if(IsStaticContentLoaded == false)
			{
				...
				lock(mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("InstructionButtonStaticUnload", UnloadStaticContent);
						mHasRegisteredUnload = true;
					}
				}
				bool registerUnload = false;
				if(!FlatRedBallServices.IsLoaded<Scene>(@"content/entities/instructionbutton/scenefile.scnx", ContentManagerName))
				{
					registerUnload = true;
				}
				SceneFile = FlatRedBallServices.Load<Scene>(@"content/entities/instructionbutton/scenefile.scnx", ContentManagerName);
				if(!FlatRedBallServices.IsLoaded<AnimationChainList>(@"content/entities/instructionbutton/animationchainlistfile.achx", ContentManagerName))
				{
					registerUnload = true;
				}
				AnimationChainListFile = FlatRedBallServices.Load<AnimationChainList>(@"content/entities/instructionbutton/animationchainlistfile.achx", ContentManagerName);
	...
	// Extra classes
	public static class InstructionButtonExtensionMethods
	{
	}
