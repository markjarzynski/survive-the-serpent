...
{
	public partial class StoneSnakeTail : PositionedObject, IDestroyable
	{
        ...
        public StoneSnakeTail(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public StoneSnakeTail(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
...
// Generated AddToManagers
		...
		public static void LoadStaticContent(string contentManagerName)
		{
			...
			if(IsStaticContentLoaded == false)
			{
				...
				lock(mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("StoneSnakeTailStaticUnload", UnloadStaticContent);
						mHasRegisteredUnload = true;
					}
				}
				bool registerUnload = false;
				if(!FlatRedBallServices.IsLoaded<Scene>(@"content/entities/stonesnaketail/scenefile.scnx", ContentManagerName))
				{
					registerUnload = true;
				}
				SceneFile = FlatRedBallServices.Load<Scene>(@"content/entities/stonesnaketail/scenefile.scnx", ContentManagerName);
				if(!FlatRedBallServices.IsLoaded<AnimationChainList>(@"content/entities/stonesnaketail/animationchainlistfile.achx", ContentManagerName))
				{
					registerUnload = true;
				}
				AnimationChainListFile = FlatRedBallServices.Load<AnimationChainList>(@"content/entities/stonesnaketail/animationchainlistfile.achx", ContentManagerName);
	...
	// Extra classes
	public static class StoneSnakeTailExtensionMethods
	{
	}
