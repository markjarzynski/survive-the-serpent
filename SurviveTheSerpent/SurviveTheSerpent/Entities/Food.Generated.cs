...
// Generated AddToManagers
		...
		public static void LoadStaticContent(string contentManagerName)
		{
			...
			if(IsStaticContentLoaded == false)
			{
				...
				if(!FlatRedBallServices.IsLoaded<AnimationChainList>(@"content/entities/food/animationchainlistfile.achx", ContentManagerName))
				{
					registerUnload = true;
				}
				AnimationChainListFile = FlatRedBallServices.Load<AnimationChainList>(@"content/entities/food/animationchainlistfile.achx", ContentManagerName);
